...
# dynamic_resolution_h_w: key---h/w, value---{key---approximate resolution, value---{'pixel': resolution, 'scales'}}
dynamic_resolution_h_w = {}
# predefined_HW_Scales_dynamic: spatial shape for latent corresponded scales
